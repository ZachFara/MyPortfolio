      ...
      <section>
        ...
        <div className="repo-container">
          <div className="repo-card" style={{
            ...
            <a className="repo-link" href="https://github.com/ZachFara/SkySearch" target="_blank" rel="noopener noreferrer">View on GitHub</a>
          ...
          <div className="repo-card">
            ...
            <a className="repo-link" href="https://github.com/ZachFara/Chartwell-Insurance-AI/tree/revamp" target="_blank" rel="noopener noreferrer">View on GitHub</a>
            <div className="repo-meta">
              <span className="repo-stars">★ 1</span>
              <span className="repo-language"><i className="fab fa-python"></i> Python</span>
            </div>
